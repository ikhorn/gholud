...
#define ROW_PORT								PORTD							//(калибратор)
#define ROW_DDR									DDRD
#define ROW_PIN									PIND
#define ROW1_B									0
#define ROW2_B									1
...
#define INT_PORT								PORTE							//порт прерываний
#define INT_DDR									DDRE
#define INT_PIN									PINE
#define INT_B									6
...
#define ROW1_1									'c'								//ряд 1(калибратор)
#define ROW1_2									'7'
#define ROW1_3									'8'
#define ROW1_4									'9'
#define ROW1_5									'='

#define ROW2_1									'b'								//ряд 2
#define ROW2_2									'4'
#define ROW2_3									'5'
#define ROW2_4									'6'
#define ROW2_5									'.'

#define ROW3_1									'a'								//ряд 3
#define ROW3_2									'1'
#define ROW3_3									'2'
#define ROW3_4									'3'
#define ROW3_5									'0'
...
#define COL_MASK								(B(COL1_B)|B(COL2_B)|B(COL3_B)|	\
												B(COL4_B)|B(COL5_B))
...
#define INT_ROW3_WAS                            INT_WAS_INT2
																				...
																				//настраивает тип всех прерываний
...
{																				\
	...
	INT_ROW3_SET_TYPE();														\
																				...
																				//стирает флаги от всех прерываний
...
static ubase_t kbd_Rx_Key(void)
{
	uint8_t rows;	//карта рядов
	uint8_t cols;	//карта столбов
	rows = ROWS;
	DOWN_ROWS();
	PULLUP_COLS();
	delay_us(5);
